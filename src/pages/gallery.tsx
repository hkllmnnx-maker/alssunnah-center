const galleryImages = [
  { category: 'students', icon: 'fa-users', title: 'حلقات تحفيظ القرآن', desc: 'طلاب المركز خلال حلقات التحفيظ', gradient: 'from-emerald-deep-700 to-emerald-deep-900' },
  { category: 'events', icon: 'fa-mosque', title: 'مبنى المركز الرئيسي', desc: 'المقر الرئيسي لمركز السنة', gradient: 'from-emerald-deep-800 to-emerald-deep-950' },
  { category: 'graduation', icon: 'fa-graduation-cap', title: 'حفل تخريج الدفعة 12', desc: 'تخريج طلاب الإجازة بالقرآن', gradient: 'from-royal-gold-600 to-royal-gold-800' },
  { category: 'students', icon: 'fa-book-quran', title: 'دورة الماهر 3', desc: 'انعقاد دورة الماهر 3', gradient: 'from-emerald-deep-600 to-emerald-deep-800' },
  { category: 'events', icon: 'fa-handshake', title: 'استقبال وفد علمي', desc: 'زيارة العلماء للمركز', gradient: 'from-royal-gold-700 to-royal-gold-900' },
  { category: 'students', icon: 'fa-pen-fancy', title: 'حصص الإملاء والإتقان', desc: 'تطبيقات عملية للطلاب', gradient: 'from-emerald-deep-700 to-emerald-deep-950' },
  { category: 'lessons', icon: 'fa-book-open', title: 'درس في الفقه', desc: 'دروس الفقه التفصيلية', gradient: 'from-emerald-deep-800 to-royal-gold-700' },
  { category: 'lessons', icon: 'fa-scroll', title: 'شرح الأدب المفرد', desc: 'دروس في الأدب الإسلامي', gradient: 'from-royal-gold-600 to-emerald-deep-800' },
  { category: 'graduation', icon: 'fa-certificate', title: 'منح الإجازات العلمية', desc: 'منح إجازات القرآن للطلاب', gradient: 'from-emerald-deep-700 to-emerald-deep-900' },
  { category: 'events', icon: 'fa-microphone', title: 'محاضرات مفتوحة', desc: 'محاضرات للعموم', gradient: 'from-royal-gold-500 to-royal-gold-700' },
  { category: 'lessons', icon: 'fa-chalkboard-teacher', title: 'دروس العقيدة', desc: 'شرح متون العقيدة', gradient: 'from-emerald-deep-800 to-emerald-deep-950' },
  { category: 'students', icon: 'fa-praying-hands', title: 'برامج التزكية', desc: 'برامج تزكية النفوس', gradient: 'from-emerald-deep-700 to-royal-gold-700' },
]
      ...
      <section class="relative py-20 bg-gradient-primary text-white overflow-hidden">
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
          ...
          <nav class="text-sm mt-6">
            ...
            <span class="text-royal-gold-100">المعرض</span>
          </nav>
        </div>
      </section>
            ...
            {galleryImages.map((img, i) => (
              <div class="gallery-item filter-item bg-gradient-to-br shadow-md hover:shadow-2xl" data-category={img.category} data-aos="fade-up" data-aos-delay={i * 50}>
                <div class={`w-full h-full bg-gradient-to-br ${img.gradient} flex items-center justify-center relative`}>
                  ...
                  <i class={`fas ${img.icon} text-royal-gold-400 text-7xl relative z-10`}></i>
